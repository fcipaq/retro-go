 ...
 */
typedef struct {
    const hd395003c30_lcd_init_cmd_t *init_cmds;         /*!< Pointer to initialization commands array. Set to NULL if using default commands.
...
static const char *PANEL_TAG = "hd395003c30";
...
{
/*
    ESP_LOGI(PANEL_TAG, "version: %d.%d.%d", ESP_LCD_HD395003C30_VER_MAJOR, ESP_LCD_HD395003C30_VER_MINOR,
...
*/
    ...
    ESP_RETURN_ON_FALSE(hd395003c30, ESP_ERR_NO_MEM, PANEL_TAG, "no mem for hd395003c30 panel");
    ...
    ESP_LOGD(PANEL_TAG, "new hd395003c30 panel @%p", hd395003c30);
...
static esp_err_t panel_hd395003c30_del(esp_lcd_panel_t *panel)
{
    ...
    if (hd395003c30->reset_gpio_num >= 0) {
        ...
        gpio_set_direction(hd395003c30->reset_gpio_num, GPIO_MODE_OUTPUT);
        gpio_set_level(hd395003c30->reset_gpio_num, 0);
    }
    // Delete MIPI DPI panel
    hd395003c30->del(panel);
    free(hd395003c30);
    ESP_LOGD(PANEL_TAG, "del hd395003c30 panel @%p", hd395003c30);
...
static esp_err_t panel_hd395003c30_init(esp_lcd_panel_t *panel)
{
    ...
    ESP_RETURN_ON_ERROR(panel_hd395003c30_send_init_cmds(hd395003c30), PANEL_TAG, "send init commands failed");
    ESP_RETURN_ON_ERROR(hd395003c30->init(panel), PANEL_TAG, "init MIPI DPI panel failed");
...
static esp_err_t panel_hd395003c30_reset(esp_lcd_panel_t *panel)
{
    ...
    if (hd395003c30->reset_gpio_num >= 0) {
        ...
        gpio_set_direction(hd395003c30->reset_gpio_num, GPIO_MODE_INPUT);
        // floating means 1, since external pullup is connected
        // !! Do not set to 1, since IOVCC is 1.8V !!
        gpio_set_pull_mode(hd395003c30->reset_gpio_num, GPIO_FLOATING);
