...
} dxq3d9502_vendor_config_t;

/**
 * @brief Create LCD panel for model DXQ3D9502
 *
 ...
 *
 */
#define DXQ3D9502_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                     \
        .bus_id = 0,                                      \
        .num_data_lanes = 2,                              \
 ...
 *
 */
#define DXQ3D9502_PANEL_IO_DBI_CONFIG() \
    {                                 \
        .virtual_channel = 0,         \
        .lcd_cmd_bits = 8,            \
        .lcd_param_bits = 8,          \
 ...
 *
 */
#define DXQ3D9502_720_720_PANEL_50HZ_CONFIG(px_format)            \
    {                                                            \
        .virtual_channel = 0,                                    \
