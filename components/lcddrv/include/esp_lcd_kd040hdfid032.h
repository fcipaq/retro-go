...
} kd040hdfid032_vendor_config_t;

/**
 * @brief Create LCD panel for model KD040HDFID032
 *
 ...
 *
 */
#define KD040HDFID032_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                     \
        .bus_id = 0,                                      \
        .num_data_lanes = 2,                              \
        .phy_clk_src = MIPI_DSI_PHY_CLK_SRC_DEFAULT,      \
        .lane_bit_rate_mbps = 432,                       \
    }
 ...
 *
 */
#define KD040HDFID032_PANEL_IO_DBI_CONFIG() \
    {                                 \
        .virtual_channel = 0,         \
        .lcd_cmd_bits = 8,            \
        .lcd_param_bits = 8,          \
 ...
 *
 */
#define KD040HDFID032_720_720_PANEL_50HZ_CONFIG(px_format)            \
    {                                                            \
        .virtual_channel = 0,                                    \
        .dpi_clk_src = MIPI_DSI_DPI_CLK_SRC_DEFAULT,             \
        .dpi_clock_freq_mhz = 31,     /* 31 = 50Hz, 39=60Hz */   \  
