...
} hd395003c30_vendor_config_t;

/**
 * @brief Create LCD panel for model HD395003C30
 *
 ...
 *
 */
#define HD395003C30_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                     \
        .bus_id = 0,                                      \
        .num_data_lanes = 2,                              \
 ...
 *
 */
#define HD395003C30_PANEL_IO_DBI_CONFIG() \
    {                                 \
        .virtual_channel = 0,         \
        .lcd_cmd_bits = 8,            \
        .lcd_param_bits = 8,          \
 ...
 *
 */
#define HD395003C30_720_720_PANEL_50HZ_CONFIG(px_format)            \
    {                                                            \
        .virtual_channel = 0,                                    \
